...
2 5
*/
tab.map(function (elt) { return elt + 3; })
    .filter(function (elt) { return elt > 5; })
    .forEach(function (elt) { return console.log(elt); });
// affiche 6
var tab = [2, 3, 5];
var somme = tab.map(function (elt) { return elt + 3; })
    .filter(function (elt) { return elt > 5; })
    .reduce(function (sum, elt) { return sum + elt; });
